...
export default function Main({ pools, guesses }: MainProps) {
  ...
  const createPool = async (event: FormEvent) => {
    ...
    try {
      const response = await httpClient.post('pools', { title: poolTitle })  
            ...
            <div className="flex flex-col gap-12 pt-12">
              ...
              <div className="flex gap-4 border-t border-gray-600 justify-between divide-x divide-gray-600 pt-8">
                <div className="flex gap-2">
                  <Image src={iconCheckImg} alt="checked-circle"/>
                  <div className="flex-1">
                    <p className="text-white">+{pools}</p>
